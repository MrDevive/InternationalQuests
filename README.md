...
- **Интеграция с [`InternationalLevel`](https://github.com/MrDevive/InternationalLevel)** — награда игроков опытом и уровнями
...
**Вопрос:** Плагин не видит [`InternationalLevel`](https://github.com/MrDevive/InternationalLevel). Что делать?

**Ответ:** [`InternationalLevel`](https://github.com/MrDevive/InternationalLevel) опционален. Без него плагин не будет поддерживать тип квестов `GAIN_EXPERIENCE`, но вся остальная функциональность будет работать.
